...
El archivo Resicolector_code corresponde al codigo que debe ser cargado en el Arduino:
...
es el que se debe modificar en el codigo Resicolector_code.ino, Teniendo en cuenta los pines de conexion de cada uno de los sensores.

--------------------------------------------------------------------------------------------------------------------

El archivo Resicolector_Receptor corresponde al codigo para el circuito que se encraga de recibir los mensajes provenientes de cada Resicolector y enviando
